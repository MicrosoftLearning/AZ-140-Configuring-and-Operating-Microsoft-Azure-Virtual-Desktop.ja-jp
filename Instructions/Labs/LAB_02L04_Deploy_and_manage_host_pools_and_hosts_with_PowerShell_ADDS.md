...
ms.openlocfilehash: c51d1d76064b3dc73ca65257477f965b36542a4c
ms.sourcegitcommit: 040b38677ab4bfb0bf430a8797aaa8f524dc501c
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 04/07/2022
ms.locfileid: "145883984"
---
...
1. Azure portal で「**仮想マシン**」を検索して選択し、 **[仮想マシン]** ブレードで **az140-dc-vm11** を選択します。
...
1. **az140-dc-vm11** へのリモート デスクトップ セッション内の Azure portal で、Azure portal ページの上部にある **[リソース、サービス、ドキュメントの検索]** テキスト ボックスを使用して **仮想ネットワーク** を検索して移動し、 **[仮想ネットワーク]** ブレードで **az140-adds-vnet11** を選択します。 
