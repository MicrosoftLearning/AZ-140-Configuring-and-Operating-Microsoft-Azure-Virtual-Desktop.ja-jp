...
1. **[使用量 + クォータ]** ブレードで、**[リージョン]** を選択し、ドロップダウン リストで、このラボで使用する Azure リージョンの名前の横にあるチェック ボックスをオンにし、**[適用]** を選択して、**[コンピューティング]** エントリが **[リージョン]** エントリの左側にあるドロップダウン リストに表示されていることを確認し、検索ボックスに「**Standard DSv3**」と入力します。 
