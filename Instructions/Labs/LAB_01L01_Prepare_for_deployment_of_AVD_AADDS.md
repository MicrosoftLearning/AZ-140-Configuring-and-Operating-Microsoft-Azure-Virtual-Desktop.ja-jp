...
ms.openlocfilehash: 4074edd908da850cf9c11e39c0a1f781ce38cac7
ms.sourcegitcommit: 2662f7a0156a1931cda5a8c1d4e5573a96df5fa1
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/06/2022
ms.locfileid: "146977074"
---
...
1. クォータの要求が完了するまで待ちます。  しばらくすると、**[クォータの詳細]** ウィンドウに要求が承認されてクォータが増えたことが示されます。 **[クォータの詳細]** ウィンドウを閉じます。
...
1. [Cloud Shell] ペインを閉じます。
1. Azure portal で「**Bastions**」を検索して選択し、**[Bastions]** ウィンドウから **[+ 作成]** を選びます。
